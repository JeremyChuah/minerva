...
return (
    <div className="flex flex-col h-screen">
      ...
      <div className="bg-white shadow-sm px-6 py-4 flex items-center">
        ...
        <h1 className="text-xl font-semibold ml-4">{selectedCourse?.name} Practice Questions</h1>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        {error && (
          <div className="w-full max-w-2xl p-4 mt-4 bg-red-100 text-red-700 rounded-md">
            {error}
          </div>
        )}
        ...
        {questions && !showResults && (
          <div className="w-full max-w-2xl mt-8 bg-[#9E72C3] text-white p-6 rounded-md shadow-md">
        ...
        {showResults && (
          <div className="w-full max-w-2xl mt-8 bg-white p-6 rounded-md shadow-md">
